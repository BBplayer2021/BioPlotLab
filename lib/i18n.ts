...
export const content = {
  zh: {
    ...
    comparison: {
      ...
      beforeLabel: 'Nature Genetics 原图样式',
      afterLabel: 'BioPlot AI 1:1 复现',
      beforeTitle: 'Nature Genetics 原图样式',
      beforeDescription: '顶级期刊火山图：深灰色坐标轴、特定半透明红/蓝散点、Helvetica 字体、精确的基因标签布局',
      afterTitle: 'BioPlot AI 1:1 复现',
      afterDescription: '视觉几乎不可区分：颜色十六进制完全一致、字体大小一致、坐标轴刻度密度一致',
      precisionTitle: '精准复现',
  ...
  en: {
    ...
    comparison: {
      ...
      beforeLabel: 'Original Style (Nature Genetics)',
      afterLabel: 'BioPlot AI 1:1 Reproduction',
      beforeTitle: 'Original Style (Nature Genetics)',
      beforeDescription: 'Top-tier journal volcano plot: dark gray axes, specific semi-transparent red/blue points, Helvetica font, precise gene label layout',
      afterTitle: 'BioPlot AI 1:1 Reproduction',
      afterDescription: 'Visually almost indistinguishable: exact hex colors, matching font sizes, identical axis tick density',
